...
Role = ["CHIEF DATA CLERK", "DATA CLERK", "ACCOUNTS", "ADMINISTRATOR" , "DEPARTMENTAL LEADERS" , "ADMIN", "GUEST"]
Privilege = ['ADMIN PRIVILEGES', 'CHIEF DATA CLERK PRIVILEGES', 'DATA CLERK PRIVILEGES', 'ADMINISTRATOR PRIVILEGES', 'GUEST PRIVILEGES']
